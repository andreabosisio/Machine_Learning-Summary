...
\includegraphics[scale=0.4]{Logo_Politecnico_Milano.png}\\[2cm] % Include a department/university logo - this will require the graphicx package

%----------------------------------------------------------------------------------------
%	COPYRIGHT SECTION
%----------------------------------------------------------------------------------------

\includegraphics[scale=0.4]{Copyright.png}\\[1cm]
...
\subfile{LinearClassification}
\subfile{BiasVarianceTradeOff}
\subfile{PAC-Learning and VC-Dimension}
\subfile{KernelMethods}
\subfile{SupportVectorMachines}
\subfile{MDP}
\subfile{RLFinite}
\subfile{MAB}
